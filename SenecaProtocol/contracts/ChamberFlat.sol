...
contract SenUSD is ERC20, BoringOwnable {
    using BoringMath for uint256;
    // ERC20 'variables'
    string public constant symbol = "senUSD";
    string public constant name = "Seneca USD";
    ...
    function burn(uint256 amount) public {
        require(amount <= balanceOf[msg.sender], "senUSD: not enough");
...
contract ChamberFlat is BoringOwnable, IMasterContract {
    ...
    constructor(IBentoBoxV1 bentoBox_, IERC20 senUSD_) public {
        bentoBox = bentoBox_;
        senUSD = senUSD_;
        masterContract = this;
    }
    ...
    function reduceSupply(uint256 amount) public {
        ...
        bentoBox.withdraw(senUSD, address(this), address(this), amount, 0);
        SenUSD(address(senUSD)).burn(amount);
    }
}